	...
	private void addButtons(JLayeredPane layeredPane, int initialY) {
		...
		for (int i = 0; i < buttonNames.length; i++) {
			...
			if (i == buttonNames.length - 1) {
				...
				button.addActionListener(e -> showPanel(new AnnouncementPanel(), layeredPane)); // StaticsPanel 보여주는 동작
				...
				button.addActionListener(e -> showPanel(new AdminProfilePanel(), layeredPane)); // CounselingPanel 보여주는
